...
let itemThirteen = document.querySelector("#item-13");
itemThirteen.style.opacity = "0.5";
...
imageTwo.style.height = "300px";

let itemSixteen = document.querySelector("#item-16");
